...
function onWindowDeviceOrientation(event) {
	...
	if (event.beta) {
		...
		// Decrease sensitivity by scaling down the angles
		gravity.x = Math.sin(event.gamma * Math.PI / 360); // Divide by 2
		gravity.y = Math.sin((Math.PI / 8) + event.beta * Math.PI / 360); // Divide by 4
